...
class _FriendsListScreenState extends State<FriendsListScreen> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
                  ...
                  itemBuilder: (context, index) {
                    if (index == 0) {
                      return _buildFunctionItem(
                          ...
                          assetPath: 'assets/icon/loimoikb.png', // --- ICON LỜI MỜI MỚI ---
                    ...
                    if (index == 1) {
                      return _buildFunctionItem(
                          'Sinh nhật',
                              () {},
                          assetPath: 'assets/icon/sinhnhat.png', // --- ICON SINH NHẬT MỚI ---
                          iconSize: 24.0 // Đã thu nhỏ
                      );
                    }
  ...
  // Helper hàm để hiển thị item chức năng (Lời mời, Sinh nhật)
  Widget _buildFunctionItem(String title, VoidCallback onTap, {IconData? iconData, String? assetPath, int badgeCount = 0, double iconSize = 30.0}) {
    return Card(
      color: Colors.white,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    IconButton(
                      // --- ICON CALLING MỚI ---
                      icon: Image.asset('assets/icon/calling.png', width: 24, height: 24),
                      onPressed: () {},
                      padding: EdgeInsets.zero,
                      constraints: const BoxConstraints(),
                    ),
                    const SizedBox(width: 8), // Khoảng cách đã thu hẹp
                    IconButton(
                      // --- ICON VIDEO MỚI ---
                      icon: Image.asset('assets/icon/video (2).png', width: 26, height: 26),
                      onPressed: () {},
                      padding: EdgeInsets.zero,
                      constraints: const BoxConstraints(),
                    ),
